			...
			<div class="imdb-connector-widget-admin">
				...
				<div class="poster-options">
					<p>
						...
						<input type="text" size="1" maxlength="3" name="<?php echo $this->get_field_name("poster_size_width"); ?>" id="<?php echo $this->get_field_id("poster-size-width"); ?>" value="<?php echo $values["poster_size_width"]; ?>">
						<label for="<?php echo $this->get_field_id("poster-size-height"); ?>">
							<?php _e("Height", "imdb_connector"); ?>:
						</label>
