					...
					<tbody>
						<tr id="allow-caching-row">
							...
							<td>
								...
								<label for="allow-caching-on">
									<?php echo __("On", "imdb_connector") . ' <span class="radio-description">(' . __("movie details and poster") . ")</span>"; ?>
								</label>
								...
								<label for="allow-caching-only-movie-details">
									<?php echo __("On", "imdb_connector") . ' <span class="radio-description">(' . __("only movie details") . ")</span>"; ?>
								</label>
						...
						<tr>
							...
							<td>
								...
								<input type="radio" name="cache_location" id="cache-location-mysql" value="mysql"<?php imdb_connector_check_setting("cache_location", "mysql"); ?> />
								<label for="cache-location-mysql"><?php _e("In WordPress' MySQL database", "imdb_connector"); ?></label>
