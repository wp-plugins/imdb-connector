	...
	function build_admin_settings_page() {
		...
		<div class="wrap" id="imdb-connector-settings">
			...
			<form method="post" action="<?php echo admin_url(); ?>options-general.php?page=imdb-connector" id="settings-form">
				<input type="hidden" id="remote-actions-url" value="<?php imdb_connector_the_url(); ?>includes/remote-actions.php"/>
					...
					<tbody>
						<tr id="allow-caching-row">
							...
							<td>
								...
								<?php
									$cached_movies = count(imdb_connector_get_cached_movies());
								?>
								<p id="delete-cache-container">
									...
									<img src="<?php imdb_connector_the_url(); ?>images/loading.gif" alt="<?php _e("Loading...", "imdb_connector"); ?>" id="delete-cache-loading-icon" hidden="hidden"/>
								...
								<?php if($invalid_cache_path) { ?>
									<div id="invalid-directory">
										...
										<code><?php imdb_connector_the_cache_url(); ?></code>
									</div>
								<?php } ?>
							</td>
						</tr>
									...
									<?php
										...
										foreach((array)$shortcodes as $shortcode) {
											...
											<li class="example" id="example-<?php echo $counter; ?>">
												<p class="code"><code><?php echo $shortcode["shortcode"]; ?></code></p>
