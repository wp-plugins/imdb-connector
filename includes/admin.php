<?php
	...
	function init_admin_settings_page() {
		...
		add_options_page(__("IMDb Connector settings", "imdb_connector"), "IMDb Connector", "manage_options", "imdb-connector", "build_admin_settings_page");
	}
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<p class="description">
							<?php
								echo sprintf(__('Defines where IMDb Connector stores the cached information. Movie posters are always stored in the plugin\'s <a href="%s" target="_blank">cache directory</a>.', "sathon"), get_imdb_connector_cache_url());
							?>
						</p>
					</td>
				</tr>
				<tr id="row-database-table">
					...
					<td>
						...
						<p class="description"><?php _e("The MySQL table the movie details are being stored in.", "imdb_connector"); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row">
					...
					<td>
						<?php
							...
							foreach($checkboxes as $checkbox) {
								$checked = "";
								if(in_array($checkbox["value"], get_imdb_connector_setting("deactivation_actions"))) {
